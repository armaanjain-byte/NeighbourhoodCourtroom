...
def test_summary_with_changes():
    proposal1 = create_initial_proposal(city_slug="test", green_space_pct=20.0, affordable_housing_pct=15.0, housing_units=100, parking_spaces=150, community_center_sqft=5000.0)
    proposal2 = create_initial_proposal(city_slug="test", green_space_pct=25.0, affordable_housing_pct=20.0, housing_units=90, parking_spaces=120, community_center_sqft=6000.0)
    proposal2.version = 2
    ...
    assert "the final budget stayed exactly within your original target" in summary["finance_score"]
